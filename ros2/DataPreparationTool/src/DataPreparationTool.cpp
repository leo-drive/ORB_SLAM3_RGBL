...
DataPreparationTool::DataPreparationTool() : Node("data_preparation_tool") {
    readParameters();
    BagReader bag_reader{"/home/bzeren/projects/data_collection/bags/01/rosbag2_2023_03_30-16_28_09",
                         "/home/bzeren/projects/data_collection/bags/01/dataset/"};
}
...
BagReader::BagReader(std::string bag_path, std::string dataset_path) : Node("data_preparation_tool"),
...
//        }
    ...
    std::cout << "Finished parsing bag file" << std::endl;
    reader.close();
}
...
Eigen::Matrix4d
BagReader::visualizer(ImageData image_data, PointCloudData &point_cloud_data, const GnssData &gnss_data) {
    ...
    gnss_to_velodyne.transform.translation.x = 0;
    gnss_to_velodyne.transform.translation.y = 0;
    gnss_to_velodyne.transform.translation.z = -0.1;
